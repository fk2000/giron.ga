...
Volt.configure do |config|
  ...
  config.app_name = 'Volt-chat'
  config.mailer.from = 'Volt-chat <no-reply@volt-chat.com>'
  ...
  #
  config.app_secret = 'rQomCsqA6-j-1I8l9IDDiOWxr7oabXmBxoRfcxdUq9ktIUmiSudruDRZmrbev10ozYM'
