...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'sample-project.com'
  config.app_name = 'Sample_project'
  config.mailer.from = 'Sample_project <no-reply@sample-project.com>'
  ...
  #
  config.app_secret = '1Ubc0_HCwE0t-BdQ-ud2LigQqtA2xURgAxEW-L8Vu7qXjyIPhWXas1K_BnAzokukGkU'
